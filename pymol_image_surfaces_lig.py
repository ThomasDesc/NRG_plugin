...
def generate_session(pdb_file, surfaces_file, list_file, color_rgb_file_path, residues_of_interest=None, color_scale=None, color_scale_range=None):
    residues, atoms, values_residues, values_atoms = read_image_data(surfaces_file)
